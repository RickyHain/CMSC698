...
class DataTracker(object):
    ...
    headers = ["Move", "Player", "Dealer", "Ace", "10", "9", "8", "7", "6", "5", "4", "3", "2", "has_ace", "can_split", "can_double"]
    # bet_headers = ["Bet", "Count", "True Count", "Ace", "10", "9", "8", "7", "6", "5", "4", "3", "2", "Cards in Deck"]
    bet_headers = ["Bet", "Ace", "10", "9", "8", "7", "6", "5", "4", "3", "2"]
    csv = []
    betting = []
    ...
    def expand_csv_list(self,choice):
        ...
        line = [choice, hand.get_hand_val(), self.dealer_hand.get_hand_val()] + self.deck.get_csv() + [hand.has_ace(), hand.can_split(), hand.can_double()]
    ...
    def expand_betting_csv(self):
        ...
        line = [self.player.get_hand().get_bet()] + self.deck.get_csv()
